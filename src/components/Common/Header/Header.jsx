    ...
    <header className='header-section'>
      <Container>
        ...
        <Navbar expand="lg" className="p-0">
          {/* Start Logo Section */}
            <Navbar.Brand><NavLink to="/">Weekendmonks</NavLink></Navbar.Brand>
            {/* End Logo Section */}
            ...
            >
              ...
              {/* Start Mobile Logo Section */}
              <Offcanvas.Header>
                <h1 className="logo">Weekendmonks</h1>
                <samp className="navbar-toggler ms-auto" onClick={toggleMenu}>
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  ...
                  >
                    ...
                    <NavDropdown.Item href="#action3">FRANCE TOURS</NavDropdown.Item>
                  </NavDropdown>
